...
/bin/sed -i "s#REPLACEBYBASEFOLDER#$LBHOMEDIR#" $LBHOMEDIR/system/cron/cron.15min/$PDIR
/bin/sed -i "s#REPLACEBYSUBFOLDER#$PDIR#" $LBHOMEDIR/system/cron/cron.15min/$PDIR
